 ...
 * TSSprintf
 */
var TSSprintf = (function () {
    function TSSprintf() {
    }
    TSSprintf.sprintf = function (format) {
        var args = [];
    ...
    TSSprintf.format = function (parse_tree, argv) {
    ...
    TSSprintf.get_type = function (variable) {
    ...
    TSSprintf.str_repeat = function (input, multiplier) {
...
exports.TSSprintf = TSSprintf;
//# sourceMappingURL=TSSprintf.js.map