...
class SwitchPage extends webview_content_1.WebViewContent {
    constructor(storageManager, webviewContentHelper) {
        super(webviewContentHelper);
        this.name = "switchTo";
        this.header = new header_content_1.HeaderContent(webviewContentHelper, "Switch Database", this.name);
    ...
    processMessage(operation, name, formData) {
        ...
        if (operation === "submit" && name === "switchTo") {
            ...
            let otherFile = (_b = params.otherFile) !== null && _b !== void 0 ? _b : "";
            if (storageType === "") {
            ...
            if (storageType === "file" && otherFile === "") {
                this.storageActionResult = storage_action_result_1.StorageActionResult.simpleError("No file selected.");
                this.refreshAfterAction();
                return;
            }
            this.storageManger.executeStorageAction("switchTo", storageType, otherFile, [], new Map()).then((storageActionResult) => {
...
//# sourceMappingURL=switch_page.js.map